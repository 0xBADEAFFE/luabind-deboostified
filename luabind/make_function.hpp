...
#pragma pack(pop)
	...
	object make_function(lua_State* L, F f, bool default_scope,
		meta::type_list< SignatureElements... >, meta::type_list< PolicyInjectors... > )
	{
		return detail::make_function_aux(
			L, luabind_new<detail::function_object_impl<F, meta::type_list< SignatureElements... >,
			meta::type_list< PolicyInjectors...> >>( f ), default_scope);
	}
	...
	{
		return make_function(L, f, default_scope,
			typename detail::call_types<F>::signature_type(), meta::type_list< PolicyInjectors... >());
	}

	template <class F>
	object make_function(lua_State* L, F f, bool default_scope)
	{
		return make_function(L, f, default_scope, typename detail::call_types<F>::signature_type(), no_policies());
	}
